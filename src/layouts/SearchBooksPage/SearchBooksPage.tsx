...
export const SearchBooksPage = () => {
    ...
    const [categorySelection, setCategorySelection] = useState('カテゴリー');

    useEffect(() => {

        // using FETCH
        const fetchBooks = async () => {
            const baseUrl: string = "https://fithon.herokuapp.com/api/books";
                    ...
                    <div className='row mt-5'>
                        <div className='col-6'>
                            <div className='d-flex'>
                                ...
                                <button className='btn btn-outline-success text-nowrap' onClick={() => searchHandleChange()}>検索</button>
                            </div>
                        </div>
                        <div className='col-4'>
